...
import { providerData } from '~/tyoes';
...
const WatchProvider = ({ provider }: WatchProviderProps) => {
	return (
		<div className="fixed md:invisible bottom-0 z-10 flex h-[6.5rem] w-full flex-col justify-between bg-[#032541] bg-opacity-80 py-4 backdrop-blur-lg">
			<div>
