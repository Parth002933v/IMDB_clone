...
import { Route } from '../../.react-router/types/app/routes/+types/mediaDetail';
import { isMovieDetail } from '~/tyoes';
import FallbackImage from '~/components/fallbackImage'; // Used for extracting colors from an image
